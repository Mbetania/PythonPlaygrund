# cantidad_agua = int(input('ingrese cap max'))
# limite_min_agua = 500

# # while cant_agua < limite_min_agua:
# #     print('agregar mas agua', cant_agua)
# #     break

# if cantidad_agua < limite_min_agua | cantidad_agua < 500:
#     print(cantidad_agua)
